...
$("#menu-main li a").on('click',function (){
  owlcarousel_slider(); price_range ()//; scrolltop_arrow (); responsive_dropdown(); sidebar_margin(); video_popup(); description_tab (); custom_tab (); countdown_clock(); option_drop();  location_page ();
